...
// import { CopartSaleListScraper } from './scrapers/copart/saleList/saleListScraper.js';
...
// 			// Map cars to SaleList type
// 			const saleListCars: SaleList[] = cars.map((car) => ({
// 				title: car.title,
// 				lotNr: car.lotNumber ?? '', // or car.lotNr if that's the property name
...
// 				item: car.item ?? '',
// 				actionCountDown: car.actionCountDown ?? '',
// 				currentBid: car.currentBid ?? '',
// 				buyItNow: car.buyItNow ?? '',
// 				details: car.details ?? null,
// 				// Add any other required SaleList fields here
// 			}));
// 			const modified = await incrementalAttachSaleListByLink(link, saleListCars);
