	...
	return (
		<div className='flex flex-col '>
			...
			<CheckBoxList
				...
				icon={<Gavel strokeWidth={stroke} className='checkboxIcon' />}
			/>
			<CheckBoxList
				title='Location'
				options={location}
				...
				scrollable
				icon={<MapPin strokeWidth={stroke} className='checkboxIcon' />}
			/>
			<CheckBoxList
				title='Body style'
				options={bodyType}
				...
				icon={<Car strokeWidth={stroke} className='checkboxIcon' />}
			/>
		</div>
	);
}
