...
function Card({ ...props }) {
	const { item } = props;
	return (
		<div className='md:max-h-112.5 w-full max-w-lg md:w-[30%] lg:w-[22%] xl:w-[18%] m-1.5 bg-neutral-primary-soft border border-gray-300 rounded-base shadow-md rounded-lg flex flex-row md:flex-col'>
